...
//O cliente não pode ser uma múmia
...
const CustomerModel = z.object({
  ...
  phone: 
    z.string()
    .length(15, { message: 'O número de telefone/celular está incompleto'}),
...
Customer.parse = function(fields) {
  ...
  // Tira os espaços em branca do final do campo ident_document
  fields.ident_document = fields.ident_document.trim()

  //Tira os sublinhados que porventura existem do campo phone
